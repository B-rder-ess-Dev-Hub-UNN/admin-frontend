      ...
      <CheckIns email={email} email_handler={email_handler}>
        ...
        >
          ...
          <motion.button
            ...
            onClick={getSeat}
            className="w-[111px] h-[35px] mb-[23px] text-[15px] font-semibold lg:text-[25px] lg:w-[182px] lg:h-[59px] lg:mb-[45px] bg-yellow-400 border-[#FFDD00] border-2 border-solid rounded cursor-pointer"
          >
            Get a Seat
          </motion.button>
